...
public class RandomCitizen implements Factory<Citizen>, Citizen {
    ...
    private String pathCountry = "resources/countries.txt";
    private String pathName = "resources/first-names.txt";
    private String pathLastName = "resources/last-names.txt";
    private String code;
